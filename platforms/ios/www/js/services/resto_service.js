...
.factory('Restos',['$q','$http',function($q,$http){
  ...
  return {
    all:function(barrioId){
      ...
      $http({url : "http://dondecomo.herokuapp.com/barrios/" + barrioId + "/restos.json",method: "GET",cache:true})
    ...
    getWithPosition:function(barrioId,position){
      var deferred = $q.defer()
      $http({url : "http://dondecomo.herokuapp.com/barrios/" + barrioId + "/restos.json",method: "GET",params: { lat: position[0], lng: position[1]},cache:true})
